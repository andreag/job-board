...
class User < ActiveRecord::Base
  ...
  attr_accessible :employer_attributes 
  attr_accessible :seeker_attributes 
  ...
  attr_accessible :account_type, :login, :email, :name, :first_name, :last_name, :password, :password_confirmation
